    ...
    Item {
        ...
        Rectangle {
            ...
            color: Qt.rgba(Theme.surface_container_low.r, Theme.surface_container_low.g,
                           Theme.surface_container_low.b, 0.93)
        ...
        ScrollView {
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    spacing: 2
                    Text {
                        text: root.clockTime; color: Theme.primary
                        font.family: Theme.fontFamily; font.pixelSize: 52
                        font.weight: Font.Bold; font.letterSpacing: -2
                    }
                    Text {
                        text: root.clockDate; color: Theme.on_surface_variant
